...
* 25. (1h) Came up with a conceptual idea for a framework for the purpose of evaluating various models and determined the best way for passing the data between different parts of the code. 
